...
abstract final class AppRoutes {
  ...
  static const String customerReportedTrips =
      '/customer/profile/reported-trips';
  ...
  static const String customerEditAddress =
  ...
  static const String driverAddShipmentRequest =
      '/driver/shipment/:id/add-request';
  static const String driverInterestSuccess =
      '/driver/shipment/interest-success';
  ...
  static const String driverSubscriptionPlans = '/driver/subscription/plans';
  static const String driverSubscriptionPayment =
      '/driver/subscription/payment';
  static const String driverSubscriptionPaymentResult =
      '/driver/subscription/payment-result';
  ...
  static String customerTripRequestOf(String id) =>
      '/customer/trip/$id/request';
