...
/// In-memory customer addresses for offline / demo mode.
class LocalCustomerAddressRepository implements ICustomerAddressRepository {
  LocalCustomerAddressRepository()
      : _items = List.of(CustomerSavedAddress.seedDefaults());

  final List<CustomerSavedAddress> _items;
  int _nextId = 100;
  ...
  Future<CustomerSavedAddress> createAddress({
    ...
    await _delay();
    final id = _nextId++;
    final created = CustomerSavedAddress(
      id: id,
      label: label,
  ...
  Future<CustomerSavedAddress> updateAddress({
    ...
    final updated = CustomerSavedAddress(
      id: id,
      label: label,
      addressLine: addressLine,
      city: city,
