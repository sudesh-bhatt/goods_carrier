...
/// Icon treatment for profile bento rows — Figma `1:1931` / `1:1055`.
...
/// Profile settings row — shared customer & driver.
class AppProfileMenuRow extends StatelessWidget {
  const AppProfileMenuRow({
    super.key,
    required this.icon,
    required this.title,
...
/// Back-compat alias.
typedef CustomerProfileMenuRow = AppProfileMenuRow;
