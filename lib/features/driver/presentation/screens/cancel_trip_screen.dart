...
/// Cancel trip reason form — same layout as customer cancel shipment.
...
class _CancelTripScreenState extends ConsumerState<CancelTripScreen>
  ...
  List<_ReasonOption> _reasons(AppLocalizations l10n) => [
        _ReasonOption('routeChanged', l10n.cancelTripReasonRouteChanged),
        _ReasonOption('vehicleUnavailable', l10n.cancelTripReasonVehicleUnavailable),
        _ReasonOption('betterLoad', l10n.cancelTripReasonBetterLoad),
        _ReasonOption('incorrectDetails', l10n.cancelTripReasonIncorrectDetails),
        _ReasonOption('other', l10n.cancelTripReasonOther),
      ];
  ...
  Widget build(BuildContext context) {
    ...
    final trip = ref.watch(driverTripsProvider).byId(widget.tripId);

    if (trip == null) {
      return Scaffold(
        backgroundColor: CancelShipmentTokens.screenBg,
        appBar: FlowScreenAppBar(
          title: l10n.driverCancelTrip,
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            _CancelFooter(
              submitLabel: l10n.driverCancelTrip,
              keepLabel: l10n.cancelTripKeep,
